// myteam-columns.js — Column visibility, ordering, and picker logic for myteam.html
...
function saveWLColPrefs() {
    ...
    if (window.firebaseInitialized && team) {
        ...
        window.firebaseSet(window.firebaseRef(window.firebaseDB, 'colprefs/' + team.toLowerCase()), payload)
